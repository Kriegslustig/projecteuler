...
class TestLargestPrimeFactorial(unittest.TestCase):
	...
	def test_isPrime(self):
		...
		self.assertTrue(self.largestPrimeFactorial.isPrime(7), msgTrue + str(7))
		self.assertFalse(self.largestPrimeFactorial.isPrime(15), msgFalse + str(15))
		self.assertFalse(self.largestPrimeFactorial.isPrime(788), msgFalse + str(788))
